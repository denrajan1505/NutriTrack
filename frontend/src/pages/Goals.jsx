  ...
  return (
    <div className="space-y-5">
        ...
        <div className="card bg-gradient-to-br from-brand-50 to-white border-brand-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white rounded-xl p-3 text-center shadow-sm">
              <p className="text-2xl font-bold text-yellow-500">{existingGoal.daily_calorie_target}</p>
              <p className="text-xs text-gray-500 mt-0.5">Daily Calories</p>
            </div>
            <div className="bg-white rounded-xl p-3 text-center shadow-sm">
              <p className="text-2xl font-bold text-blue-500">{existingGoal.daily_protein_target}g</p>
              <p className="text-xs text-gray-500 mt-0.5">Daily Protein</p>
            </div>
            <div className="bg-white rounded-xl p-3 text-center shadow-sm">
              <p className="text-2xl font-bold text-purple-500">{existingGoal.daily_carbs_target}g</p>
              <p className="text-xs text-gray-500 mt-0.5">Daily Carbs</p>
            </div>
            <div className="bg-white rounded-xl p-3 text-center shadow-sm">
              <p className="text-2xl font-bold text-cyan-500">{existingGoal.daily_water_target}L</p>
      ...
      <div className="card">
        ...
        <GoalSetting existing={existingGoal} onSaved={handleSaved} />
      </div>
    </div>
  )
}
